...
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,qBAAqB;EACrB,uBAAuB;EACvB,6BAA6B;EAC7B,uBAAuB;AACzB;;AAEA;EACE,SAAS;EACT,sBAAsB;EACtB,gBAAgB;EAChB,8CAA8C;AAChD;;AAEA;EACE,aAAa;EACb,QAAQ;EACR,uBAAuB;EACvB,mBAAmB;EACnB,mCAAmC;EACnC,aAAa;AACf;;AAEA;EACE,mBAAmB;EACnB,YAAY;EACZ,iBAAiB;EACjB,eAAe;EACf,iBAAiB;EACjB,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,2BAA2B;EAC3B,SAAS;EACT,uBAAuB;AACzB;;AAEA;EACE,2CAA2C;EAC3C,mBAAmB;EACnB,aAAa;AACf;;AAEA;EACE,aAAa;EACb,kCAAkC;EAClC,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,UAAU;AACZ;;AAEA;;;EAGE,WAAW;EACX,YAAY;EACZ,uBAAuB;EACvB,mBAAmB;EACnB,eAAe;AACjB;;AAEA;;;EAGE,6BAA6B;AAC/B;;AAEA,QAAQ;AACR;EACE,eAAe;EACf,WAAW;EACX,iBAAiB;EACjB,OAAO;EACP,MAAM;EACN,WAAW;EACX,YAAY;EACZ,cAAc;EACd,oCAAoC;AACtC;;AAEA;EACE,mCAAmC;EACnC,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,WAAW;EACX,8BAA8B;AAChC;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;;AAEA;;;EAGE,mBAAmB;EACnB,YAAY;EACZ,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,UAAU;EACV,YAAY;EACZ,YAAY;AACd;;AAEA;;EAEE,aAAa;EACb,2CAA2C;AAC7C","sourcesContent":[":root {\n  --main-color: #155263;\n  --orange-color: #ff6f3c;\n  --light-orange-color: #ff9a3c;\n  --yellow-color: #ffc93c;\n}\n\n* {\n  margin: 0;\n  box-sizing: border-box;\n  line-height: 1.5;\n  font-family: \"Courier New\", Courier, monospace;\n}\n\nheader {\n  display: flex;\n  gap: 8vw;\n  justify-content: center;\n  align-items: center;\n  background-color: var(--main-color);\n  padding: 12px;\n}\n\n.add-project {\n  border-radius: 12px;\n  border: none;\n  padding: 6px 10px;\n  font-size: 1rem;\n  font-weight: bold;\n  cursor: pointer;\n}\n\n#content {\n  margin: 32px;\n  display: grid;\n  grid-template-columns: 50vw;\n  gap: 32px;\n  justify-content: center;\n}\n\n.project {\n  background-color: var(--light-orange-color);\n  border-radius: 12px;\n  padding: 24px;\n}\n\n.project > div {\n  display: grid;\n  grid-template-columns: 4fr 1fr 1fr;\n  cursor: pointer;\n}\n\n.project > div > * {\n  display: inline;\n}\n\n.project > div > h3 + p {\n  grid-column: 2 / 4;\n}\n\n.low h3 {\n  color: green;\n}\n\n.medium h3 {\n  color: yellow;\n}\n\n.high h3 {\n  color: red;\n}\n\nimg.plus,\nimg.check,\nimg.close {\n  width: 32px;\n  height: 32px;\n  border: 2px solid black;\n  border-radius: 100%;\n  cursor: pointer;\n}\n\nimg.plus:hover,\n.modal-content input:hover,\n.add-project:hover {\n  box-shadow: 2px 2px 6px black;\n}\n\n/*Modal*/\n.modal {\n  position: fixed;\n  z-index: 10;\n  padding-top: 20vh;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n.modal-content {\n  background-color: var(--main-color);\n  margin: auto;\n  padding: 32px;\n  border-radius: 20px;\n  width: 40vw;\n  box-shadow: 6px 6px 10px black;\n}\n\n.modal-content form {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n\n.modal-content form div input,\n.modal-content form div select,\n.modal-content input[type=\"submit\"] {\n  border-radius: 12px;\n  border: none;\n  padding: 4px;\n  margin-left: 4px;\n}\n\n.modal-content input[type=\"submit\"] {\n  width: 20%;\n  padding: 8px;\n  margin: auto;\n}\n\n.modal-content form div input:focus,\n.modal-content form div select:focus {\n  outline: none;\n  border: var(--light-orange-color) 2px solid;\n}\n"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   modalPrompt: () => (/* binding */ modalPrompt),
/* harmony export */   projectsLoadHTML: () => (/* binding */ projectsLoadHTML)
/* harmony export */ });
...
function projectsLoadHTML() {
  content.innerHTML = "";
  for (let i = 0; i < _todos_js__WEBPACK_IMPORTED_MODULE_0__.projects.length; i++) {
    const projectDiv = createProjectDiv(_todos_js__WEBPACK_IMPORTED_MODULE_0__.projects[i], i);
...
function createProjectDiv(project, i) {
  ...
  project.tasks.forEach((element) => {
    ...
    dueDate.textContent = "Due: " + (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(element.dueDate, "do MMMM yyyy");
    ...
    taskDiv.addEventListener("click", (event) => {
      if (taskDiv.classList.contains("expanded")) {
        ...
        checkIconElem.src = _icons_check_svg__WEBPACK_IMPORTED_MODULE_2__;
        checkIconElem.classList.add("check");

        taskDiv.appendChild(checkIconElem);

        const closeIconElem = new Image();
        closeIconElem.src = _icons_close_svg__WEBPACK_IMPORTED_MODULE_3__;
  ...
  plusIconElem.src = _icons_plus_svg__WEBPACK_IMPORTED_MODULE_1__;
...
document.querySelector("button.add-project").addEventListener("click", () => {
  ...
  if (name && name !== "") {
    (0,_todos_js__WEBPACK_IMPORTED_MODULE_0__.createProject)(name);
    projectsLoadHTML();
  }
});
...
function modalPrompt(id) {
  ...
  modalDiv.addEventListener("click", (event) => {
    if (event.target == modalDiv) {
      ...
      if(_todos_js__WEBPACK_IMPORTED_MODULE_0__.projects[id].tasks.find((item) => item.title == input1)){
        alert("Task with this name already exists.");
      } else {
        (0,_todos_js__WEBPACK_IMPORTED_MODULE_0__.userCreateTask)(id, input1, input2, input3, select.value);
        document.querySelector("div.modal").remove();
        projectsLoadHTML();
      }
    }
...
/* harmony export */   userCreateTask: () => (/* binding */ userCreateTask)
/* harmony export */ });
class task {
...
function userCreateTask(id, title, desc, date, prio) {
